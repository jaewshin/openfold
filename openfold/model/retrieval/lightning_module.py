...
class RetrievalAugmentedLightningModule(pl.LightningModule):
    ...
    def __init__(
        ...
        rawseq_esm1b_fallback_backend: Optional[str] = None,
        rawseq_esm1b_allow_download: bool = True,
        rawseq_esm1b_hf_cache_dir: Optional[str] = None,
        rawseq_esm1b_torch_hub_dir: Optional[str] = None,
        ...
        if retrieval_pipeline == "rawseq_esm1b_ragstyle":
            ...
            if rawseq_seq_context_encoder_override is not None:
                ...
                seq_context_encoder = ESM1bContextEncoder(
                    ...
                    fallback_backend=rawseq_esm1b_fallback_backend,
                    allow_download=rawseq_esm1b_allow_download,
                    hf_cache_dir=rawseq_esm1b_hf_cache_dir,
                    torch_hub_dir=rawseq_esm1b_torch_hub_dir,
