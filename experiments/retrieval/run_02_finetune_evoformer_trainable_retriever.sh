...
#SBATCH --job-name=retrieval_ft02_evoformer_retriever
#SBATCH -N 1
#SBATCH -c 8
#SBATCH --gpus=1
#SBATCH --mem=64G
#SBATCH --time=2-00:00
#SBATCH --output=/insomnia001/depts/pmg/users/js6118/openfold/logs/retrieval_ft02_evoformer_retriever_%j.out
#SBATCH --error=/insomnia001/depts/pmg/users/js6118/openfold/logs/retrieval_ft02_evoformer_retriever_%j.err
#SBATCH --no-requeue
...
RUN_TAG="retrieval_ft02_evoformer_retriever_effbs128_lr5e-5"
