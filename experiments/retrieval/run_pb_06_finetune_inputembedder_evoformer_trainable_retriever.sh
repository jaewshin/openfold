...
#SBATCH --job-name=retr_pb06_input_evo_retriever
#SBATCH -N 1
#SBATCH -c 8
#SBATCH --gpus=1
#SBATCH --mem=64G
#SBATCH --time=2-00:00
#SBATCH --output=/insomnia001/depts/pmg/users/js6118/openfold/logs/retrieval_pb06_input_evo_retriever_rawseq_effbs128_lr5e-5_%j.out
#SBATCH --error=/insomnia001/depts/pmg/users/js6118/openfold/logs/retrieval_pb06_input_evo_retriever_rawseq_effbs128_lr5e-5_%j.err
#SBATCH --no-requeue
...
RUN_TAG="retrieval_pb06_input_evo_retriever_rawseq_effbs128_lr5e-5"
